...
func _on_set_stance(_stance: Stance) -> void:
	var stance_name: String = str(_stance.name)
	animation_tree["parameters/stance_transition/transition_request"] = stance_name
